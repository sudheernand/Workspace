...
public class PersonssDAO {
	public boolean create(List<PersonssDetails> array) throws PersonDAOException {
		...
		for (int i = 0; i < array.size(); i++) {
			PersonssDetails pobj = new PersonssDetails();
			pobj = array.get(i);
	...
	public boolean update(PersonssDetails pObj) throws PersonDAOException {
		boolean result = false;
		String id = pObj.getId();
