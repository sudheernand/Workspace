...
/**
 * Session Bean implementation class EmployeeDAOJMS
 */
@Stateless(mappedName = "jndiEmployeeDAOJMSObj")
@LocalBean
public class EmployeeDAOJMS implements IEmployeeDAOJMS {

	/**
	 * Default constructor.
	 */
	public EmployeeDAOJMS() {
	}
