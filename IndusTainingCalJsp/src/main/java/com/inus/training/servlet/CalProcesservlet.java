package com.inus.training.servlet;
...
/**
 * Servlet implementation class CalProcesservlet
 */
public class CalProcesservlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public CalProcesservlet() {
		super();
	}
